    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div([
                ...
                html.P("Voeg toe en verwijder met onderstaande knoppen. Je kan de lijnen verschuiven door erop te klikken en te slepen. De tabel onder de grafiek wordt zo automatsich geüpdatet.",  # noqa: E501
